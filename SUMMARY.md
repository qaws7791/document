...
- [🚀Next](document/next/readme.md)
  - [Common Tips](document/next/common-tips.md)
  - [Create Navigation](document/next/create-navigation.md)
  - [Create Page](document/next/create-page.md)
  - [Create Search](document/next//create-search.md)
  - [Environment variables](document/next/environment-variables.md)
  - [Fetch In Next](document/next/fetch-in-next.md)
  - [Rendering](document/next/rendering.md)
  - [Server Action](document/next/server-action.md)
- [🔍SEO](document/seo/readme.md)
- [⚫Express](document/node/express.md)
- [🟣GraphQL](document/graphql/readme.md)
- [ℹ️API](document/api/readme.md)
- [CI&CD](document/cicd/readme.md)

## Software Engineering

- [SOLID Principle](document/software-engineering/solid-principles.md)
...
- [AWS Lambda](document/aws/lambda/readme.md)
  ...
  - [User Lambda With Apigateway](document/aws/lambda/user-lamdba-with-apigateway.md)
  - [AWS Lambda](document/aws/lambda/readme.md)
