---
title: Selecting
description: 선택 알고리즘은 데이터에서 특정 순위에 해당하는 값을 찾는 문제를 해결하는 알고리즘입니다.
---


## 선택 문제란

선택 문제(Selection Problem)는 **주어진 데이터에서 특정 순위에 해당하는 값을 찾는 문제**를 말합니다. 주로 데이터 과학에서 중앙값을 찾기 위해 사용됩니다.
