...
| ----------------- | ------------------------------------------------ | ------------------------------------------------------------ |
| \0                | 널(null)문자                                     |                                                              |
| \b                | 백스페이스 문자                                  | 1let arr = [0, 0, 0];2let arr2 = arr;3let arr3 = [...arr];4arr[0] = 1;5arr2[1] = 2;6arr3[2] = 3;7console.log(arr); // [1, 2, 0]8console.log(arr2); // [1, 2, 0]9console.log(arr3); // [0, 0, 3]javascript |
| \t                | 수평 탭 문자                                     |                                                              |
| \n                | 개행 문자                                        |                                                              |
| \v                | 수직 탭 문자                                     |                                                              |
| \f                | 다음 페이지 문자                                 |                                                              |
